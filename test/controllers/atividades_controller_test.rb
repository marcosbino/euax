...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post atividades_url, params: { atividade: { dataFim: @atividade.dataFim, dataIni: @atividade.dataIni, finalizada: @atividade.finalizada, nome: @atividade.nome, projeto_id: @atividade.projeto_id } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { dataFim: @atividade.dataFim, dataIni: @atividade.dataIni, finalizada: @atividade.finalizada, nome: @atividade.nome, projeto_id: @atividade.projeto_id } }

...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { dataFim: @projeto.dataFim, dataIni: @projeto.dataIni, nome: @projeto.nome } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { dataFim: @projeto.dataFim, dataIni: @projeto.dataIni, nome: @projeto.nome } }
